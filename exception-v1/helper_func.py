...
def normalize_input_data(string: str, shift: str) -> tuple[str, int]:
    ...
    try:
        ...
        server_logger.exception("Не удалось преобразовать данные")
        return e
    except ValueError as e:
        server_logger.exception("Некорректное значение")
        return e
    except BaseException as e:
        server_logger.exception(f"Произошла непредвиденная ситуация. Данные: {string}, {shift}. Ошибка: {e}")
